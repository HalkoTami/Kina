...
class LibFragPopUpConfirmMoveToFileCL(val binding: LibraryFragPopupConfirmMoveToFileBinding,
                                      val chooseFileMoveToViewModel: ChooseFileMoveToViewModel, ): View.OnClickListener{
    override fun onClick(v: View?) {
        binding.apply {
            when(v){
                ...
                btnCommitMove -> {
                    chooseFileMoveToViewModel.moveSelectedItemToFile(chooseFileMoveToViewModel.returnFileMoveTo() ?:return)
                }
