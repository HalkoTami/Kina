...
class GuideActions(val activity:MainActivity){
    ...
    val edtEditFileTitle                    get() = mainActivityBinding.bindingWidgetPwEditFile.edtFileTitle
    private val editFileBinding     get() = mainActivityBinding.bindingWidgetPwEditFile
    ...
    val imvBnvBtnAdd                get() = mainActivityBinding.bindingWidgetTwgActivityMain.bnvImvAdd
    val frameLayCreateFlashCard     get() = mainActivityBinding.bindingWidgetPmAddItem.frameLayNewFlashcard
    private val frameLayCreateFolder        get() = mainActivityBinding.bindingWidgetPmAddItem.frameLayNewFolder
    val frameLayCreateCard          get() = mainActivityBinding.bindingWidgetPmAddItem.frameLayNewCard
    val frameLayEditFile            get() = mainActivityBinding.flPwEditFile
    val btnCloseEditFilePopUp       get() = mainActivityBinding.bindingWidgetPwEditFile.btnClose
    val btnCreateFile               get() = mainActivityBinding.bindingWidgetPwEditFile.btnFinish
