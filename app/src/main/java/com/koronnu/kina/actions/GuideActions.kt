...
class GuideActions(val activity:MainActivity){
    ...
    val edtEditFileTitle                    get() = mainActivityBinding.bindingPwEditFile.edtFileTitle
    private val editFileBinding     get() = mainActivityBinding.bindingPwEditFile
    ...
    private val twgActivityMainBinding      get() = mainActivityBinding.bindingTwgActivityMain
    val imvBnvBtnAdd                get() = twgActivityMainBinding.imvCreateNewItems
    val frameLayCreateFlashCard     get() = mainActivityBinding.bindingPmAddNewItem.frameLayNewFlashcard
    private val frameLayCreateFolder        get() = mainActivityBinding.bindingPmAddNewItem.frameLayNewFolder
    val frameLayCreateCard          get() = mainActivityBinding.bindingPmAddNewItem.frameLayNewCard
    val frameLayEditFile            get() = mainActivityBinding.flPwEditFile
    val btnCloseEditFilePopUp       get() = mainActivityBinding.bindingPwEditFile.btnClose
    val btnCreateFile               get() = mainActivityBinding.bindingPwEditFile.btnFinish
    ...
    private val frameLayBnv                 get() = mainActivityBinding.flTwgActivityMain
